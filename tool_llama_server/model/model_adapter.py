...
from common_utils import get_gpu_memory
...
class ToolLlamaAdapterParallel(BaseAdapter):
    "Model adapater for tool-llama-parallel"

    def match(self, model_path: str):
        return "tool-llama-parallel" == model_path
    ...
    def get_default_conv_template(self, model_path: str) -> Conversation:
        return get_conv_template("tool-llama-parallel")


class ToolLlama3AdapterParallel(BaseAdapter):
    "Model adapater for tool-llama-parallel"

    def match(self, model_path: str):
        return "tool-llama3-parallel" == model_path
    ...
    def get_default_conv_template(self, model_path: str) -> Conversation:
        return get_conv_template("tool-llama3-parallel")
...
register_model_adapter(ToolLlamaAdapterParallel)
register_model_adapter(ToolLlama3AdapterParallel)
