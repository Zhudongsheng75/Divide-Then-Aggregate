...
from inference.utils import SimpleChatIO, react_parser
from inference.Prompts.ReAct_prompts import FORMAT_INSTRUCTIONS_SYSTEM_FUNCTION_ZEROSHOT
...
class Davinci:
    ...
    def parse(self, functions, process_id, **args):
        ...
        for function_dict in functions:
            ...
            if "Finish" in api_name:
                ...
                api_desc = function_dict["description"][
                    function_dict["description"].find("The description of this function is: ")
                    + len("The description of this function is: ") :
                ]
        ...
        prompt = (
            FORMAT_INSTRUCTIONS_SYSTEM_FUNCTION_ZEROSHOT.replace("{func_str}", func_str)
