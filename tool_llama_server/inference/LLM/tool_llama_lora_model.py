...
from common_utils import process_system_message
from model.model_adapter import get_conversation_template
from inference.utils import SimpleChatIO, generate_stream, react_parser
...
class ToolLLaMALoRA:
    def __init__(
        ...
        model = LlamaForCausalLM.from_pretrained(
            base_name_or_path, load_in_8bit=load_8bit, torch_dtype=torch.float16, device_map="auto"
        )
